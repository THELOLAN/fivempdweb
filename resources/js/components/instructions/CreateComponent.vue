                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Service instructions</h3>
...
export default {
    ...
    methods: {
        postData() {
            this.form.post('/dienstanweisungen/erstellen')
                .then((response) => {
                    this.$router.push({ name: 'instructions-index'})
                    this.$noty.success("Du hast die Dienstanweisung erfolgreich erstellt.",{
                        theme: 'relax',
                        timeout: 4000
                    })
                })
