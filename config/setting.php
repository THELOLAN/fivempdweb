...
return [
    ...
    */
    'override' => [
        "database.mysql.host" => "database.main.host",
        "database.mysql.database" => "database.main.name",
        "database.mysql.username" => "database.main.username",
        "database.mysql.password" => "database.main.password",
        "database.ingame.host" => "database.main.host",
        "database.ingame.database" => "database.main.name",
        "database.ingame.username" => "database.main.username",
        "database.ingame.password" => "database.main.password"
    ],
